#' FusioMR: Main Function for MR analysis for single exposure multiple outcomes
#'
#' @description
#' A Flexible, Unified and verSatile Mendelian Randomization framework
#'
#' @param summary_stats_raw A data frame with 6 columns: b_exp, se_exp, b_out1, se_out1, b_out2, se_out2
...
#' @export
#'
fusiomr_seso <- function(summary_stats_raw,
                         type,
